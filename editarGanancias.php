...
$queryi="UPDATE ganancias SET Descripcion='$Descripcion',PrecioPrevisto='$PrecioPrevisto', PrecioReal='$PrecioReal', Diferencia='$Diferencia' where Item='$Item'";//consulta sql
